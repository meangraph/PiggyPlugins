...
import com.Swiper.OneClickCoinPouchOpener.OneClickCoinPouchOpenerPlugin;
...
public class ExamplePluginTest {
    public static void main(String[] args) throws Exception {
        ExternalPluginManager.loadBuiltin(EthanApiPlugin.class, PacketUtilsPlugin.class,
                //new stuff
                CoxPlugin.class, LizardmanShamanPlugin.class, OneClickRunEnablePlugin.class, OneClickCoinPouchOpenerPlugin.class);
        RuneLite.main(args);
    }
}
package com.Swiper.CoxHelper.Utils;

//Credit to Dey0, Used to determine what room the player is in
//Taken from https://github.com/dey0/pluginhub-plugins/blob/cox-additions/src/main/java/de0/util/CoxUtil.java
